...
function* requestGetBalance(action) {
  try {
    ...
    const soloBalance = response.find(
      item => item.currency === "534F4C4F00000000000000000000000000000000",
    );
    if (response) {
...
const setTrustline = account => {
  ...
  return sologenic.submit({
    ...
    LimitAmount: {
      currency: solo,
      issuer: "rMiTTf8TA9co9Pmzuzy7bVBr1mTwXzmpyU", //this is a test issuer for solo which is generated by sologenic-issuarance
      value: "400000000",
    },
    Flags: 131072,
  });
...
const transferSolo = (account, destination, value) => {
  ...
  return sologenic.submit({
    ...
    SendMax: {
      ...
      issuer: "rMiTTf8TA9co9Pmzuzy7bVBr1mTwXzmpyU",
      value: value + 1,
    },
    Amount: {
      currency: "534F4C4F00000000000000000000000000000000",
...
const issuer = "rMiTTf8TA9co9Pmzuzy7bVBr1mTwXzmpyU"; //this is a test issuer for solo which is generated by sologenic-issuarance
